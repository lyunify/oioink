...
// functions
// use form for submit
const vectordbForm = document.getElementById("vector-db-form");
vectordbForm.addEventListener("submit", function () {
...
function showAlert() {
    ...
    alertMsg.innerHTML = "<div class='alert alert-success d-inline-flex' role='alert'>Creating vector DB in progress</div>";
